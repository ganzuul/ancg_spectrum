...
// Note: this is runtime telemetry, not persistent profile state.
struct calibration_telemetry final
{
...
calibration_telemetry& shared_calibration_telemetry();
...
private:
    ...
    // - Brownian telemetry for raw vs filtered noise-energy contribution
...
private:
    ...
    settings_alpha_spectrum s;
    void pull_telemetry_into_ui(bool commit_to_settings);
