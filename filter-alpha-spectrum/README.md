...
- Filter state and telemetry definitions: [filter-alpha-spectrum/ftnoir_filter_alpha_spectrum.h](filter-alpha-spectrum/ftnoir_filter_alpha_spectrum.h)
- Settings dialog telemetry presentation: [filter-alpha-spectrum/ftnoir_filter_alpha_spectrum_dialog.cpp](filter-alpha-spectrum/ftnoir_filter_alpha_spectrum_dialog.cpp)
...
2. **Improve telemetry-action coupling**
